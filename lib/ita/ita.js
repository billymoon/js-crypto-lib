ITA = (function(){
  ...
  */
   ...
   */
  ita.pack = function(text,password,private_key,exponent){
 
      // create the return object
      var ret = {}

      // call rsa enc using password as text to encrypt, and providing private key
      ret.password = ita.rsa.enc(password,private_key,exponent);
      
      // pack with DEFLATE
      var c = ita.deflate(text)
  ...
  ita.unpack = function(d, p){
      ...
      var inflated = ita.inflate(plain)
   ...
   */
  ita.decrypt = function(packed,private_key){
   ...
   */
  ita.generate_keys = function(bits,e){ e = e || "10001"; bits = bits || 512
...
if(typeof module != "undefined"){ module.exports = ITA }